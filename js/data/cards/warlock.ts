...
card({ id: 'pact_of_haste', name: 'Pact of Haste', school: 'Warlock', cat: 'Power', rarity: 'Uncommon', disabled: true,
...
card({ id: 'shadow_barrage', name: 'Shadow Barrage', school: 'Warlock', cat: 'Signature', sub: 'Sustained', rarity: 'Common',
...
card({ id: 'hellfire', name: 'Hellfire', school: 'Warlock', cat: 'Signature', sub: 'AoE', rarity: 'Common',
...
card({ id: 'demon_skin', name: 'Demon Skin', school: 'Warlock', cat: 'Technique', rarity: 'Common',
...
card({ id: 'fear', name: 'Fear', school: 'Warlock', cat: 'Technique', rarity: 'Common',
...
card({ id: 'dark_bargain', name: 'Dark Bargain', school: 'Warlock', cat: 'Technique', rarity: 'Uncommon', disabled: true,
...
card({ id: 'rain_of_fire', name: 'Rain of Fire', school: 'Warlock', cat: 'Signature', sub: 'AoE', rarity: 'Uncommon',
...
card({ id: 'life_drain', name: 'Life Drain', school: 'Warlock', cat: 'Signature', sub: 'Sustained', rarity: 'Uncommon',
...
card({ id: 'doom', name: 'Doom', school: 'Warlock', cat: 'Power', rarity: 'Uncommon', disabled: true,
...
card({ id: 'burning_pact', name: 'Burning Pact', school: 'Warlock', cat: 'Technique', rarity: 'Uncommon', disabled: true,
...
card({ id: 'infernal_gate', name: 'Infernal Gate', school: 'Warlock', cat: 'Signature', sub: 'Summon', rarity: 'Rare',
...
card({ id: 'malefic_echo', name: 'Malefic Echo', school: 'Warlock', cat: 'Technique', rarity: 'Rare', disabled: true,
  cost: 3, channel: 0.7, targeting: 'none', tags: ['Curse', 'Engine'], glyph: '⧉', element: 'shadow',
  text: 'The next Warlock Signature repeats once at 85% power.',
  effects: [{ type: 'mod', match: { school: 'Warlock', cat: 'Signature' }, count: 1, buff: { repeat: 1, dmgMult: 0.85 } }] });

card({ id: 'apocalypse', name: 'Apocalypse', school: 'Warlock', cat: 'Signature', sub: 'AoE', rarity: 'Legendary',
  cost: 5, channel: 2.6, targeting: 'self', preview: { r: 225 }, tags: ['Fire', 'Shadow', 'AoE'], glyph: '☢', element: 'fire',
