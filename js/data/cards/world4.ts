...
card({ id: 'thunderclap', name: 'Thunderclap', school: 'Mage', cat: 'Signature', sub: 'AoE', rarity: 'Rare', world: 4,
...
card({ id: 'standing_wave', name: 'Standing Wave', school: 'Mage', cat: 'Signature', sub: 'Sustained', rarity: 'Uncommon', world: 4,
...
card({ id: 'grace_note', name: 'Grace Note', school: 'Mage', cat: 'Technique', rarity: 'Common', world: 4,
...
card({ id: 'ninefold_knell', name: 'Ninefold Knell', school: 'Warrior', cat: 'Signature', sub: 'AoE', rarity: 'Rare', world: 4,
...
card({ id: 'processional', name: 'Processional', school: 'Warrior', cat: 'Technique', rarity: 'Uncommon', world: 4,
...
card({ id: 'rebuke', name: 'Rebuke', school: 'Warrior', cat: 'Technique', rarity: 'Common', world: 4,
...
card({ id: 'silent_snare', name: 'Silent Snare', school: 'Rogue', cat: 'Technique', rarity: 'Uncommon', world: 4,
...
card({ id: 'ricochet_aria', name: 'Ricochet Aria', school: 'Rogue', cat: 'Signature', sub: 'Sustained', rarity: 'Rare', world: 4,
...
card({ id: 'curtain_call', name: 'Curtain Call', school: 'Rogue', cat: 'Technique', rarity: 'Common', world: 4,
...
card({ id: 'call_and_answer', name: 'Call and Answer', school: 'Colorless', cat: 'Power', rarity: 'Uncommon', world: 4,
...
card({ id: 'the_grand_rest', name: 'The Grand Rest', school: 'Colorless', cat: 'Technique', rarity: 'Uncommon', world: 4,
...
card({ id: 'metronome', name: 'Metronome', school: 'Colorless', cat: 'Power', rarity: 'Common', world: 4,
...
card({ id: 'the_lost_chord', name: 'The Lost Chord', school: 'Colorless', cat: 'Signature', sub: 'AoE', rarity: 'Legendary', world: 4,
