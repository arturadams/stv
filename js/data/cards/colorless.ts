...
card({ id: 'draw', name: 'Draw', school: 'Colorless', cat: 'Power', rarity: 'Common',
...
card({ id: 'extend', name: 'Extend', school: 'Colorless', cat: 'Power', rarity: 'Uncommon',
...
card({ id: 'quickcast', name: 'Quickcast', school: 'Colorless', cat: 'Power', rarity: 'Common',
  ...
  effects: [{ type: 'mod', match: { cat: 'Signature' }, buff: { channelMult: 0.5, dmgMult: 0.8 } }] });

card({ id: 'grand_channel', name: 'Grand Channel', school: 'Colorless', cat: 'Power', rarity: 'Uncommon',
  ...
  effects: [{ type: 'mod', match: { cat: 'Signature' }, buff: { channelMult: 1.6, dmgMult: 1.7, radiusMult: 1.25 } }] });

card({ id: 'duplicate', name: 'Duplicate', school: 'Colorless', cat: 'Power', rarity: 'Uncommon',
...
card({ id: 'flush_queue', name: 'Flush Queue', school: 'Colorless', cat: 'Power', rarity: 'Rare',
...
card({ id: 'echo', name: 'Echo', school: 'Colorless', cat: 'Power', rarity: 'Uncommon',
...
card({ id: 'battery', name: 'Battery', school: 'Colorless', cat: 'Power', rarity: 'Common',
...
card({ id: 'shuffle', name: 'Shuffle', school: 'Colorless', cat: 'Power', rarity: 'Common',
...
card({ id: 'purge', name: 'Purge', school: 'Colorless', cat: 'Power', rarity: 'Uncommon',
...
card({ id: 'overload', name: 'Overload', school: 'Colorless', cat: 'Power', rarity: 'Uncommon',
  ...
  effects: [{ type: 'mod', match: { cat: 'Signature' }, buff: { costMult: 2, dmgMult: 2.2, radiusMult: 1.3 } }] });

card({ id: 'stabilize', name: 'Stabilize', school: 'Colorless', cat: 'Power', rarity: 'Common',
...
card({ id: 'momentum', name: 'Momentum', school: 'Colorless', cat: 'Power', rarity: 'Uncommon',
...
card({ id: 'grand_flush', name: 'Grand Flush', school: 'Colorless', cat: 'Power', rarity: 'Legendary',
...
// Card System v2 (rework_cards.md) §1/§17: no Colorless cards in the
// initial prototype — the whole file is queue-manipulation/engine content.
// Kept registered (not deleted) but excluded from every live pool.
