...
card({ id: 'venom_aspect', name: 'Venom Aspect', school: 'Druid', cat: 'Power', rarity: 'Uncommon',
...
card({ id: 'pounce', name: 'Pounce', school: 'Druid', cat: 'Skill', rarity: 'Common',
...
card({ id: 'barkskin', name: 'Barkskin', school: 'Druid', cat: 'Skill', rarity: 'Common',
...
card({ id: 'renewal', name: 'Renewal', school: 'Druid', cat: 'Skill', rarity: 'Uncommon',
...
card({ id: 'entangling_roots', name: 'Entangling Roots', school: 'Druid', cat: 'Spell', sub: 'AoE', rarity: 'Common',
...
card({ id: 'hurricane', name: 'Hurricane', school: 'Druid', cat: 'Spell', sub: 'Sustained', rarity: 'Common',
...
card({ id: 'moonbeam', name: 'Moonbeam', school: 'Druid', cat: 'Spell', sub: 'AoE', rarity: 'Uncommon',
...
card({ id: 'lightning_bloom', name: 'Lightning Bloom', school: 'Druid', cat: 'Spell', rarity: 'Uncommon',
...
card({ id: 'thorn_volley', name: 'Thorn Volley', school: 'Druid', cat: 'Spell', sub: 'Sustained', rarity: 'Uncommon',
...
card({ id: 'natures_bounty', name: "Nature's Bounty", school: 'Druid', cat: 'Trigger', rarity: 'Uncommon',
...
card({ id: 'primal_fury', name: 'Primal Fury', school: 'Druid', cat: 'Modifier', rarity: 'Rare',
...
card({ id: 'starfall', name: 'Starfall', school: 'Druid', cat: 'Spell', sub: 'AoE', rarity: 'Rare',
...
card({ id: 'world_tree', name: 'World Tree', school: 'Druid', cat: 'Spell', sub: 'AoE', rarity: 'Legendary',
  cost: 6, channel: 2.5, targeting: 'self', preview: { r: 220 }, tags: ['Nature', 'Healing', 'AoE'], glyph: '♣', element: 'gold',
