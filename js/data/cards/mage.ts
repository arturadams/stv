...
card({ id: 'meteor', name: 'Meteor', school: 'Mage', cat: 'Signature', sub: 'AoE', rarity: 'Rare',
...
card({ id: 'frost_nova', name: 'Frost Nova', school: 'Mage', cat: 'Signature', sub: 'AoE', rarity: 'Common',
...
card({ id: 'rune_prison', name: 'Rune Prison', school: 'Mage', cat: 'Signature', sub: 'AoE', rarity: 'Uncommon',
...
card({ id: 'arc_lightning', name: 'Arc Lightning', school: 'Mage', cat: 'Signature', sub: 'Sustained', rarity: 'Common',
...
card({ id: 'flame_stream', name: 'Flame Stream', school: 'Mage', cat: 'Signature', sub: 'Sustained', rarity: 'Uncommon',
...
card({ id: 'blizzard', name: 'Blizzard', school: 'Mage', cat: 'Signature', sub: 'AoE', rarity: 'Uncommon',
...
card({ id: 'mana_burst', name: 'Mana Burst', school: 'Mage', cat: 'Technique', rarity: 'Common',
  cost: 1, channel: 0.5, targeting: 'self', preview: { r: 130 }, tags: ['Arcane', 'AoE', 'Mana'], glyph: '❋', element: 'arcane',
  text: 'A pulse of raw arcana. Gain 2 Mana for each enemy struck.',
  effects: [{ type: 'aoe', r: 130, dmg: 8, flowPerHit: 2 }] });

card({ id: 'teleport', name: 'Teleport', school: 'Mage', cat: 'Technique', rarity: 'Common',
  cost: 2, channel: 0.5, dur: 8, targeting: 'self', tags: ['Movement', 'Dash', 'Arcane'], glyph: '✧', element: 'arcane',
...
card({ id: 'elemental_cycle', name: 'Elemental Cycle', school: 'Mage', cat: 'Power', rarity: 'Rare',
...
card({ id: 'pyromancy', name: 'Pyromancy', school: 'Mage', cat: 'Power', rarity: 'Uncommon',
...
card({ id: 'time_warp', name: 'Time Warp', school: 'Mage', cat: 'Power', rarity: 'Rare',
  cost: 3, channel: 0.4, targeting: 'none', tags: ['Channel', 'Engine'], glyph: '⌛', element: 'arcane',
  text: 'For 6s, your Signatures channel much faster.',
  effects: [{ type: 'haste', mult: 2, dur: 6 }] });

card({ id: 'arcane_singularity', name: 'Arcane Singularity', school: 'Mage', cat: 'Signature', sub: 'AoE', rarity: 'Legendary',
  cost: 5, channel: 2.6, targeting: 'nearest', preview: { r: 210 }, tags: ['Arcane', 'AoE', 'Control'], glyph: '✦', element: 'arcane',
