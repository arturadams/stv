...
card({ id: 'dread_command', name: 'Dread Command', school: 'Necromancer', cat: 'Power', rarity: 'Uncommon',
...
card({ id: 'raise_dead', name: 'Raise Dead', school: 'Necromancer', cat: 'Spell', sub: 'Summon', rarity: 'Common',
...
card({ id: 'bone_spear', name: 'Bone Spear', school: 'Necromancer', cat: 'Skill', rarity: 'Common',
...
card({ id: 'grave_grasp', name: 'Grave Grasp', school: 'Necromancer', cat: 'Skill', rarity: 'Common',
...
card({ id: 'soul_ward', name: 'Soul Ward', school: 'Necromancer', cat: 'Skill', rarity: 'Common',
...
card({ id: 'wraith_walk', name: 'Wraith Walk', school: 'Necromancer', cat: 'Skill', rarity: 'Uncommon',
...
card({ id: 'plague_ground', name: 'Plague Ground', school: 'Necromancer', cat: 'Spell', sub: 'AoE', rarity: 'Common',
...
card({ id: 'bone_storm', name: 'Bone Storm', school: 'Necromancer', cat: 'Spell', sub: 'Sustained', rarity: 'Uncommon',
...
card({ id: 'corpse_bloom', name: 'Corpse Bloom', school: 'Necromancer', cat: 'Spell', sub: 'AoE', rarity: 'Rare',
...
card({ id: 'frailty', name: 'Frailty', school: 'Necromancer', cat: 'Modifier', rarity: 'Uncommon',
...
card({ id: 'death_knell', name: 'Death Knell', school: 'Necromancer', cat: 'Trigger', rarity: 'Uncommon',
...
card({ id: 'dark_covenant', name: 'Dark Covenant', school: 'Necromancer', cat: 'Modifier', rarity: 'Rare',
...
card({ id: 'army_of_the_dead', name: 'Army of the Dead', school: 'Necromancer', cat: 'Spell', sub: 'Summon', rarity: 'Legendary',
  cost: 6, channel: 2.5, targeting: 'self', tags: ['Minion', 'Soul'], glyph: '♚', element: 'shadow',
