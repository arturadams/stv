...
card({ id: 'crush_depth', name: 'Crush Depth', school: 'Mage', cat: 'Signature', sub: 'AoE', rarity: 'Rare', world: 3,
...
card({ id: 'maelstrom', name: 'Maelstrom', school: 'Mage', cat: 'Signature', sub: 'Sustained', rarity: 'Uncommon', world: 3,
...
card({ id: 'still_water', name: 'Still Water', school: 'Mage', cat: 'Technique', rarity: 'Common', world: 3,
...
card({ id: 'breach', name: 'Breach', school: 'Warrior', cat: 'Signature', sub: 'AoE', rarity: 'Rare', world: 3,
...
card({ id: 'undertow_rush', name: 'Undertow Rush', school: 'Warrior', cat: 'Technique', rarity: 'Uncommon', world: 3,
...
card({ id: 'drowned_resolve', name: 'Drowned Resolve', school: 'Warrior', cat: 'Technique', rarity: 'Common', world: 3,
...
card({ id: 'drowning_snare', name: 'Drowning Snare', school: 'Rogue', cat: 'Technique', rarity: 'Uncommon', world: 3,
...
card({ id: 'squall', name: 'Squall', school: 'Rogue', cat: 'Signature', sub: 'Sustained', rarity: 'Rare', world: 3,
...
card({ id: 'brine_burst', name: 'Brine Burst', school: 'Rogue', cat: 'Technique', rarity: 'Common', world: 3,
...
card({ id: 'ebb_and_flow', name: 'Ebb and Flow', school: 'Colorless', cat: 'Power', rarity: 'Uncommon', world: 3,
...
card({ id: 'slipstream', name: 'Slipstream', school: 'Colorless', cat: 'Power', rarity: 'Uncommon', world: 3,
...
card({ id: 'deep_current', name: 'Deep Current', school: 'Colorless', cat: 'Power', rarity: 'Common', world: 3,
...
card({ id: 'worldflood', name: 'Worldflood', school: 'Colorless', cat: 'Signature', sub: 'AoE', rarity: 'Legendary', world: 3,
